...
class RetronPipelineOrchestrator:
    ...
    def __init__(self, args):
        ...
        self.script_paths = {
            'step1': '/ibex/user/rioszemm/the-retron-project/positive_data2/TEST_SCRIPT_31_nov_v5.py',
            'extract_myrt': '/ibex/user/rioszemm/the-retron-project/pipeline/extract_mrt_output_2_dic.py',
            'extract_padloc': '/ibex/user/rioszemm/the-retron-project/pipeline/extract_padloc_outputs_1_dic.py',
            'parse_defensefinder': '/ibex/user/rioszemm/the-retron-project/pipeline/parse_defense_finder_1_dic.py',
            'integrate': '/ibex/user/rioszemm/the-retron-project/pipeline/rt_integration_corrected.py',
            'annotate_ncrna': '/ibex/user/rioszemm/the-retron-project/pipeline/ANNOTATE_bprna.py'
        }
...
Examples:
  ...
  python retron_pipeline_orchestrator.py \\
    ...
    parser.add_argument('--protein-similarity-threshold', 
                       type=float, 
                       default=0.95,
                       help='Minimum similarity threshold for protein match (default: 0.95)')
    parser.add_argument('--ncrna-similarity-threshold', 
                       type=float, 
                       default=0.10,
                       help='Minimum similarity threshold for ncRNA match (default: 0.90)')
